...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
				<div class="col">
                <input type="text" class="form-control" name="productname" value="<?php  echo $product['product_name'];?>" >
                </div>
        </div>
		
		  <div class="form-group">
		
				<div class="col"><input type="text" class="form-control" name="productprice" value="<?php  echo $product['product_price'];?>" ></div>
         ...
         <div class="form-group">
                ...
                <?php
				$productcate=$productObj->displayCategorypro();
                // $result=mysqli_query($con, "select * from category ");
               foreach( $productcate as $pro ){
                 ?>

				<option value = '<?=$pro['category_id']?>'><?=$pro['category_name']?></option>
			    <?php
			}?>
			    </select>
                </div>
